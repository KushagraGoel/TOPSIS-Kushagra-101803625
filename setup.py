...
setup(
  ...
  description = 'Evaluation of TOPSIS Score',   # Give a short description about your library
  author = 'Kushagra Goel',                   # Type in your name
  author_email = 'kushgoel1608@gmail.com',      # Type in your E-Mail
  url = 'https://github.com/user/reponame',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/KushagraGoel/TOPSIS-Kushagra-101803625/archive/1.0.tar.gz',    # I explain this later on
